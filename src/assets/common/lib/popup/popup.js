...
PopLayer.prototype.miss=function(json){
    ...
    var str='<div class="popup popup-hide" onclick="closeThisPopup(this)">';
		str+='<div class="popup_main popup_miss" style="'+this.setting.style+'"><div class="maminContent maskMain miss_popup">';
...
PopLayer.prototype.loading=function(json){
    ...
    var str='<div class="popup popup-loading">';
		str+='<div class="popup_main popup_miss" style="'+this.setting.style+'"><div class="maminContent maskMain">';
        str+='<div class="content content-no">'+this.setting.title+'</div>';
        str+='</div></div></div>';     
    addendHtml(str);
    middle(); //居中
