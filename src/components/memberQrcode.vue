						...
						<div class="qrcode-panel">
							...
							<template v-else>
								<div class="qrcode-loading-card">
									<!--正在加载,请稍后...-->
									<img src="../assets/common/images/loading.gif" class="qrcode-loading-img"/>
									正在加载,请稍后...
								</div>
...
<script>
	import signalR from "common/js/signalR"
	export default {
		props: ['show'],
	    data: function(){
	        return {
	    ...
	    watch: {
	    	show (val, oldVal) {
      			//TODO: 演示代码 (删除)
      			this.qrcodeImgSrc = require("../assets/common/images/test/1490060610.png");
      			if(val){
